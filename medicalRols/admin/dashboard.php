<?php
  ...
  $adminId=$_SESSION['id'];
  $ret = mysqli_query($con,"SELECT doctorName, doctorEmail, doctorContact FROM principalUsers WHERE id='$adminId'");
            ...
            <div class="principalPanelBody">
              <div class="d-flex align-items-stretch justify-content-around top" style="margin-top: 3rem !important;">
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-7">
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item"><h4><?php  echo $user;?></h4></li>
                        <li class="list-group-item"><h4><?php  echo $email;?></h4></li>
                ...
                <card class="shadow-lg quickAccess">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item"><h3 class="quickAccessLinks"><a href="addPatient.php" style="text-decoration: none;">Añadir doctor</a></h3></li>
                    <li class="list-group-item"><h3 class="quickAccessLinks"><a href="listPatients.php" style="text-decoration: none;">Lista de doctores</a></h3></li>
                    <li class="list-group-item disabled"><h3 class="quickAccessLinks"><a href="#" style="color: #6c757d; text-decoration: none;">Configuracion</a></h3></li>
                  </ul>
                </card>
              </div>
