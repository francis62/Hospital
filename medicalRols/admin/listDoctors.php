<?php
    ...
    if(isset($_GET['del'])){
        mysqli_query($con,"delete from principalUsers where id = '".$_GET['id']."'");
        $_SESSION['msg']="Informacion eliminada con exito";
    }
?>
            ...
            <div class="containerListDoctors">
                ...
                <table class="table table-hover" id="tableDoctorManagement">
                    ...
                    <tbody>
                        <?php
                        $userType = "doctor";
                        $sql=mysqli_query($con,"select * from principalUsers where userType='$userType'");
                        $cnt=1;
                        ...
                        <tr>
                            ...
                            <td><?php echo $cnt;?>.</td>
                            <td><?php echo $row['doctorSpecilization'];?></td>
