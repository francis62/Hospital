<?php
  ...
  if(isset($_POST['submit'])){	
    ...
    $age=$_POST['patage'];
    $medicalHistory=$_POST['medhis'];

    $query = "INSERT INTO tblpatient(docId,patientName,patientContact,patientEmail,patientGender,patientAddress,patientAge,patientMedHis) VALUES('$docid','$name','$contact','$email','$gender','$address','$age','$medicalHistory')";

    $sql=mysqli_query($con,$query);

    if($sql){
      echo "<script>alert('Informacion añadida exitosamente');</script>";
      header('location:listPatients.php');
    }else{
      echo "<script>alert('La informacion no ha podido ser añadida');</script>";
      header('location:listPatients.php');
    }
  }
?>
        ...
        <div class="row flex-nowrap">
          ...
          <div class="col py-3" style="background-color:#c8d2e6">
            ...
            <div class="containerListPatients">         
                <form role="form" method="post" action="" class="formAddPatient">
                    <h4>Datos del paciente</h4>

                    <div class="form-floating">
                        <input type="text" name="patname" class="form-control"  placeholder="Enter Patient Name" required="true">
                        <label for="floatingTextarea">Nombre y Apellido</label>
                    </div>
                    ...
                    <div class="form-floating">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="rg-female" type="radio" name="gender" value="Mujer" id="rg-female">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="rg-male" type="radio" name="gender" value="Hombre" id="rg-male">
                    ...
                    <div class="form-floating">
                        ...
                        <label for="floatingTextarea">Enfermedad/es previa</label>
                    </div>	

                    <button type="submit" name="submit" class="btn btn-primary">Añadir paciente</button>
                </form>
            </div>
